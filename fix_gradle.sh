...
# Gradle Corruption Fix Script for ServiceHub Android App
echo "🔧 Fixing Gradle corruption issues..."
...
echo "🔄 Resetting Gradle wrapper..."
rm -rf gradle/wrapper
mkdir -p gradle/wrapper

# Create new gradle-wrapper.properties
...
# by using the same JVM as Android Studio (avoiding version conflicts)
exec "$JAVACMD" "$@"
EOF
...
if [ $? -eq 0 ]; then
    ...
    echo "Please check your Java installation and Android Studio setup."
fi